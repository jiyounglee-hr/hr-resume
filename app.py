...
- 이력서와 채용공고의 연결고리를 고려해 질문을 구성하세요."""},
    ...
    st.markdown("###### 📒 면접 순서")
    st.markdown("""
    1. 면접관 사전 미팅<br> 면접 시작 10분 전, 면접관 간 진행 방식 및 역할 분담 등을 간단히 조율합니다.
    ...
    3. 자기소개 요청<br> 지원자에게 경력 중심의 자기소개를 요청합니다. 자기소개 중에는 가능한 한 eye-contact을 유지하며 부드러운 표정으로 경청해 주세요.

    4. 자기소개 기반 질문<br> 자기소개 내용 중 궁금하거나 더 구체적인 내용을 중심으로 추가 질문을 진행합니다.

    5. 직무역량 및 적성 관련 질문<br> 지원서류를 참고하여, 직무 적합성과 역량을 확인할 수 있는 질문을 진행합니다. (✅ 위에 '🤖AI가 면접질문을 뽑아 드려요.' 기능 참고)

    6. 입사 관련 사항 확인<br> 지원자의 입사 가능일 등 일정 관련 정보를 확인해 주세요.(※ 연봉 확인은 2차 면접에서 진행됩니다.)
    ...
    <b>8. 면접 평가서 제출</b><br> 면접 종료 후, ‘📝면접평가서 제출 페이지’에서 면접자별 평가서를 작성하고 제출해 주세요. (✅제출된 평가는 자동 저장되며, 제출 완료 후 PDF 다운로드도 가능합니다.)
